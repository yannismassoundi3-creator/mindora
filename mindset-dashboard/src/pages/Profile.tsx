      ...
      case 'cgu':
        return (
          <>
            ...
            <p><strong>2. Ce qui est gratuit, ce qui est payant :</strong> le suivi des objectifs et des habitudes, le calendrier, les séries, les niveaux et les badges sont gratuits sans limite de durée ; un compte gratuit dispose de dix messages par mois avec le coach IA. L'abonnement <strong>Disciplix Pro</strong> lève cette limite : le coach répond sans compteur mensuel et sans dépense d'énergie, dans la limite de 50 messages par jour, plafond de sécurité remis à zéro chaque nuit. Il est mensuel à 9,99 € après sept jours d'essai, ou en paiement unique de 99,99 €, les deux ouvrant exactement les mêmes fonctions. Le paiement est géré par Stripe, qui reçoit seul les données bancaires. <em>Conformément à l'Article L221-28 du Code de la consommation, le droit de rétractation ne peut être exercé pour la fourniture d'un contenu numérique non fourni sur un support matériel dont l'exécution a commencé après accord préalable exprès du consommateur.</em> Le détail complet est publié sur <a href="/legal.html" target="_blank" rel="noopener">la page légale du site</a>.</p>
